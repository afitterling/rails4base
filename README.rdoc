...
* server side regexp matchings in routes.rb to control response events, e.g. 401 for security, to easily handle client side routing for angular partials/pages!
